...
<br>
    <div class="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow">
        <h4 align="center" style="color:green; font-size:30px">Editer la  Salle: </h4>
        <form @submit.prevent="submitForm">
            <div class="form-group">
                <label for="reference" style="color:red;font-size: 30px; text-decoration: underline">Libelle</label>
                <input type="text" class="form-control" id="reference" v-model="salle.libelle">
            </div>
            <div class="form-group">
                <label for="designation" style="color:red;font-size:27px">Adresse</label>
                <input type="text" class="form-control" id="designation" v-model="salle.adresse">
            </div>
            <br />
            <div class="form-group">
